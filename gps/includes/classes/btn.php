...
class btn {
	...
	static public function create($text, $type, $link='', $image='', $onclick='', $alttext='', $title='') {
		...
		if ($type == self::TYPE_LINK) {
			...
			$btn_html = <<<EOHTML
<a href="{$link_h}"{$onclick_html}><img src="{$btn_imagefile}" alt="{$alttext_value_h}"{$title_html} /></a>
EOHTML;
			...
			$btn_html = <<<EOHTML
<input type="image" src="{$btn_imagefile}" value="{$text_h}" name="submit" />
EOHTML;
	...
	static public function create_nolink($text, $image, $alttext='', $title='') {
		...
		$btn_html = <<<EOHTML
<img src="{$btn_imagefile}" alt="{$alttext_value_h}"{$title_html} />
EOHTML;
