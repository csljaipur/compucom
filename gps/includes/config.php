...
$cfg['db_password'] = 'csl@jantvdb';
$cfg['db_database'] = 'gpstracker';
$cfg['db_prefix'] = 'pt_';

$cfg['site_name'] = 'Compucom Software Limited';
...
$cfg['site_url'] = 'http://jantv.in/gps/';

//$cfg['googlemap_api_key'] = 'ABQIAAAAjjNDtk2TMrtZJnkMlqHv_BTmYWmikNWtRLvdVO-4mEcIHhmj8hSUtZKPQKJga1uC8HITiK0R9KA0kA';
$cfg['googlemap_api_key'] = 'AIzaSyCMK4pbJOv1DTecVKd4wRHh_poYhM5PY0k';

$cfg['map_default_lat'] = 26.789205;
$cfg['map_default_lon'] = 75.829445;
$cfg['map_default_zoom'] = 7;

$cfg['dispupd_interv_sec'] = 5;

$cfg['email_contact'] = 'manoja@jantv.in';
$cfg['email_system_from'] = 'manoja@jantv.in';

$cfg['pda_pages'] = array('pda', 'pda_map');

$cfg['pda_map_size'] = array('width' => 200, 'height' => 200);

$cfg['demo_username'] = 'demo@jantv.in';

$cfg['timezone_default'] = 'Asia/Calcutta';
