...
EOJSON;
	...
	//Retrieve map data
	$position_result = $db->table_query($db->tbl($tbl['position']), $db->col(array('id', 'unit_id', 'datetime', 'lat', 'lon', 'alt', 'deg', 'speed_km', 'sattotal', 'fixtype')), $db->cond(array("id = {$marker_id}", "(fixtype = 2 OR fixtype = 3)"), 'AND'));
