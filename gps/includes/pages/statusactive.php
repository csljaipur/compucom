...
<script language="javascript">
	...
	function getUserReport(obj1,obj2)
	{
		
		var days = obj1[obj1.selectedIndex].value;
		var userid = obj2[obj2.selectedIndex].value;
		//alert("Hello "+days+" "+userid);
		$("#lastActiveStatus").load("includes/pages/status_since_last_active.php",{checkdate:days, userid:userid});
	}	
...
<body>
 <table width="98%" border="1" bgcolor="#F00FFF" style="margin-top:0px;">
 	...
 	<tr  height="22px;">
		...
		<td width="16%" style="font-size:18px; margin:0px; color:#4387fd;" >Status Since Last</td> 
		<td width="15%" align="left" style="font-size:18px; margin:0px; padding:0px;" > 
			...
			<td width="12%" id="pageheading" align="center" >Dasboard of </td>
			<td width="30%" id="pageheading" align="center" ><?php include("getLoginUsersList.php"); ?></td>				
